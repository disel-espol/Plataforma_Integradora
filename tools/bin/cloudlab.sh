...
then
	...
	expect "*>"
	send "./tpcc.lua --mysql-socket=/tmp/mysql_sandbox8022.sock --mysql-user=root --mysql-password=msandbox --mysql-db=database_mysql --threads=64 --tables=2 --scale=$7 --time=240 prepare\r"
	expect "*>"
	send "./tpcc.lua --mysql-socket=/tmp/mysql_sandbox8022.sock --mysql-user=root --mysql-password=msandbox --mysql-db=database_mysql --threads=64 --tables=2 --scale=$7 --time=240 --report-interval=1 run\r"
	expect "*>"
	send "./tpcc.lua --mysql-socket=/tmp/mysql_sandbox8022.sock --mysql-user=root --mysql-password=msandbox --mysql-db=database_mysql --threads=64 --tables=2 --scale=$7 --time=240 --report-interval=1 cleanup\r"
	expect "*>"
	send "exit\r"
	EOD
...
then
	...
	send "cd sysbench-tpcc\r"
	expect "*>"
	send "./tpcc.lua --pgsql-user=postgres --pgsql-password=12345 --pgsql-db=database_postgres --time=240 --threads=56 --report-interval=1 --tables=2 --scale=$7 --use_fk=0 --trx_level=RC --db-driver=pgsql prepare\r"
	expect "*>"
	send "./tpcc.lua --pgsql-user=postgres --pgsql-password=12345 --pgsql-db=database_postgres --time=240 --threads=56 --report-interval=1 --tables=2 --scale=$7 --use_fk=0 --trx_level=RC --db-driver=pgsql run\r"
	expect "*>"
	send "./tpcc.lua --pgsql-user=postgres --pgsql-password=12345 --pgsql-db=database_postgres --time=240 --threads=56 --report-interval=1 --tables=2 --scale=$7 --use_fk=0 --trx_level=RC --db-driver=pgsql cleanup\r"
	expect "*>"
	send "exit\r"
	EOD
...
then
	...
	send "cd sysbench-tpcc\r"
	expect "*>"
	send "./tpcc.lua --mysql-socket=/tmp/mysql_sandbox10508.sock --mysql-user=root --mysql-password=msandbox --mysql-db=database_mariadb --threads=64 --tables=2 --scale=$7 --time=240 prepare\r"
	expect "*>"
	send "./tpcc.lua --mysql-socket=/tmp/mysql_sandbox10508.sock --mysql-user=root --mysql-password=msandbox --mysql-db=database_mariadb --threads=64 --tables=2 --scale=$7 --time=240 --report-interval=1 run\r"
	expect "*>"
	send "./tpcc.lua --mysql-socket=/tmp/mysql_sandbox10508.sock --mysql-user=root --mysql-password=msandbox --mysql-db=database_mariadb --threads=64 --tables=2 --scale=$7 --time=240 --report-interval=1 cleanup\r"
	expect "*>"
	send "exit\r"
	EOD
